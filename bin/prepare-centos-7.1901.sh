...
export IMGID=9000
export IMG="CentOS-7-x86_64-GenericCloud-1901.qcow2"
export STORAGEID="bitness-nfs"

if [ ! -f "${IMG}" ];then
  wget https://cloud.centos.org/centos/7/images/CentOS-7-x86_64-GenericCloud-1901.qcow2.xz
  xz --decompress CentOS-7-x86_64-GenericCloud-1901.qcow2.xz
fi
